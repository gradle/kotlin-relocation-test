...
class RelocationTest extends Specification {
    ...
    def expectedResults() {
        ...
        builder.put(':samples:compileKotlin', SUCCESS)
        ...
        builder.put(':spek-dsl:common:classes', SUCCESS)
        builder.put(':spek-dsl:common:compileJava', NO_SOURCE)
        builder.put(':spek-dsl:common:compileKotlinCommon', SUCCESS)
        ...
        builder.put(':spek-dsl:jvm:compileKotlin', SUCCESS)
        ...
        builder.put(':spek-extension:data-driven:common:classes', SUCCESS)
        builder.put(':spek-extension:data-driven:common:compileJava', NO_SOURCE)
        builder.put(':spek-extension:data-driven:common:compileKotlinCommon', SUCCESS)
        ...
        builder.put(':spek-extension:data-driven:jvm:compileKotlin', SUCCESS)
        ...
        builder.put(':spek-extension:subject:common:classes', SUCCESS)
        builder.put(':spek-extension:subject:common:compileJava', NO_SOURCE)
        builder.put(':spek-extension:subject:common:compileKotlinCommon', SUCCESS)
        ...
        builder.put(':spek-extension:subject:jvm:compileKotlin', SUCCESS)
        ...
        builder.put(':spek-runner:junit5:compileKotlin', SUCCESS)
        ...
        builder.put(':spek-runtime:common:classes', SUCCESS)
        builder.put(':spek-runtime:common:compileJava', NO_SOURCE)
        builder.put(':spek-runtime:common:compileKotlinCommon', SUCCESS)
        ...
        builder.put(':spek-runtime:jvm:compileKotlin', SUCCESS)
