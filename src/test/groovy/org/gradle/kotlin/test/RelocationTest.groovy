...
class RelocationTest extends Specification {
    ...
    def expectedResults() {
        ...
        builder.put(":integration-test:compileKotlinMacos", SUCCESS)
        builder.put(":spek-runtime:compileKotlinLinux", SUCCESS)
        builder.put(":spek-dsl:compileKotlinMacos", SUCCESS)
        ...
        builder.put(":integration-test:macosMainKlibrary", SUCCESS)
        ...
        builder.put(":spek-dsl:macosMainKlibrary", SUCCESS)
        builder.put(":spek-dsl:linkTestDebugExecutableMacos", NO_SOURCE)
        ...
        builder.put(":spek-runtime:compileKotlinMacos", SUCCESS)
        ...
        builder.put(":spek-runtime:macosMainKlibrary", SUCCESS)
        builder.put(":spek-runtime:linkTestDebugExecutableMacos", NO_SOURCE)
        ...
        builder.put(":spek-ide-plugin-intellij-base-jvm:compileKotlin", SUCCESS)
        ...
        builder.put(":integration-test:linkTestDebugExecutableMacos", SUCCESS)
